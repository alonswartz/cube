...
<div class="container-fluid">
  <div class="row flex-xl-nowrap">
    ...
    <main class="col-12 col-md-9 col-xl-8 py-md-3 pl-md-3 bd-content" role="main">
      ...
      <p>Even since I started speedcubing I've always wanted a reference of algorithms with a play button to visualize how the alg moves the pieces.  I couldn't find anything comprehensive, so this was born.</p>
