<div class="row">
  ...
  <div class="col-md-5 col-sm-6">
    ...
    <div class="text-nowrap">
        ...
        <p class="alg">U2 (R' U R U' R' U R) y (L' U L)</p>
        <p class="alg">y R' F R2 U' R' U2 F'</p>
  ...
  <div class="col-md-5 col-sm-6">
    ...
    <div class="text-nowrap">
        ...
        <p class="alg">y' U2 (R' F R F') (R' U' R)</p>
        <p class="alg">y U' L U' L' U L U L' y' R U' R'</p>
  ...
  <div class="col-md-5 col-sm-6">
    ...
    <div class="text-nowrap">
        ...
        <p class="alg">(U R U' R')2 (L U2 L')</p>
        <p class="alg">y U2 R2 u' R2 u R2</p>
  ...
  <div class="col-md-5 col-sm-6">
    ...
    <div class="text-nowrap">
        ...
        <p class="alg">y R' F U' F' R</p>
        <p class="alg">y2 R u R' U R u' R'</p>
    </div>
  </div>
</div>
