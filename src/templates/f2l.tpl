  ...
  <div class="row flex-xl-nowrap">
    ...
    <main class="col-12 col-md-9 col-xl-8 py-md-3 pl-md-3 bd-content" role="main">
      ...
      <h1 id="basic-f2l">Basic F2L</h1>
        <p class="bd-lead">41 basic cases. Most are solved intuitively.
        (<a target="blank" href="http://bit.ly/bestf2l">PDF</a>,
        <a target="blank" href="https://www.youtube.com/watch?v=UKRtFQmnKfs">Video</a>).</p>
      ...
      <h1 id="advanced-f2l">Advanced F2L</h1>
        <p class="bd-lead">36 advanced cases. One piece in the wrong slot.
        (<a target="blank" href="http://bit.ly/bestf2l">PDF</a>,
        <a target="blank" href="https://www.youtube.com/watch?v=UKRtFQmnKfs">Video</a>).</p>
